 ...
 * @param[in] snpeBuilderHandle Handle to access the SNPEBuilder object
 *
 * @param[in] queueDepth Maximum number of async execute calls that can be enqueued
 *
 */
SNPE_API
Snpe_ErrorCode_t Snpe_SNPEBuilder_SetAsyncExecuteQueueDepth(Snpe_SNPEBuilder_Handle_t snpeBuilderHandle, uint32_t queueDepth);
 ...
 *
 * @return Error code. Returns SNPE_SUCCESS if successful
 */
SNPE_API
Snpe_ErrorCode_t Snpe_SNPEBuilder_SetFileReadMemoryBudget(Snpe_SNPEBuilder_Handle_t snpeBuilderHandle, uint64_t fileReadMemoryBudgetInMb);
 ...
 */
SNPE_API
Snpe_ErrorCode_t Snpe_SNPEBuilder_RegisterMultiContext(Snpe_SNPEBuilder_Handle_t snpeBuilderHandle,
                                                       uint64_t groupId,
 ...
 *
 * @return SNPE_SUCCESS when successfully applied
 */
SNPE_API
 ...
 *
 * @return SNPE_SUCCESS on setting the option
 */
SNPE_API
Snpe_ErrorCode_t Snpe_SNPEBuilder_SetDeferredInit(Snpe_SNPEBuilder_Handle_t snpeBuilderHandle, bool deferredInit);

/**
 * @brief Sets deferred runtime/backend cleanup
 *
 * @param[in] snpeBuilderHandle Handle to access the SNPEBuilder object
 *
 * @param[in] deferredCleanup bool value that indicates if deferred backend cleanup is enabled or not
 *
 * @return SNPE_SUCCESS on setting the option
 *
 ...
 *       up backend resources via calling Snpe_Util_CleanupRuntime()
 */
SNPE_API
Snpe_ErrorCode_t Snpe_SNPEBuilder_SetDeferredRuntimeCleanup(Snpe_SNPEBuilder_Handle_t snpeBuilderHandle, bool deferredCleanup);
